...
const projects = [
  {
    ...
    tech: "Python + NLP + ML",
    thumbnail: "/cyber_bullying_ui_1785228820466.png",
...
function ProjectCard({ item }) {
  return (
    <a
      ...
      className="block group relative rounded-2xl border border-white/15 overflow-hidden bg-white/[0.06] 
    ...
    >
      ...
      <div className="p-5 flex flex-col gap-2">
        <h3 className="text-white font-semibold text-sm group-hover:text-accent transition-colors duration-300">{item.title}</h3>
        <div className="flex items-center justify-between">
          ...
          <div
            ...
            group-hover:bg-white/10 group-hover:text-white group-hover:border-white/30 
...
const CertificateIcon = () => (
  <svg className="w-16 h-16 text-white/20 group-hover:text-white/40 transition-colors duration-500 group-hover:scale-110 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
