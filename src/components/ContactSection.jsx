...
export default function ContactSection() {
    ...
    animate-[shine_4s_linear_infinite]"
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            {/* gmail */}
                            <a
                                href="mailto:paulwinpaul2001@gmail.com"
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-5 mb-8">
                        {/* GitHub */}
                        <a
                            href="https://github.com/Paulwin-SR"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="GitHub"
        ...
        hover:-translate-y-1.5 hover:scale-105 hover:border-white/40"
                        ...
                        {/* LinkedIn */}
                        <a
                            href="https://www.linkedin.com/in/paulwinsr"
                            target="_blank"
                            rel="noopener noreferrer"
                            aria-label="LinkedIn"
                            className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
        ...
        shadow-[0_10px_30px_rgba(0,0,0,0.28)]
        transition-all duration-500 ease-out
        hover:-translate-y-1.5 hover:scale-105 hover:border-[#0A66C2]/50"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-[#0A66C2]/18 via-[#0A66C2]/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                            <div className="absolute inset-[1px] rounded-[19px] bg-[#0b0b12]/80" />
                            <div className="absolute -inset-6 bg-[#0A66C2]/0 blur-2xl transition-all duration-500 group-hover:bg-[#0A66C2]/20" />

                            <FaLinkedin className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-[#0A66C2]" />
                        </a>
                    </div>
