...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        >
          Building robust full-stack applications with clean, responsive, elegant interfaces and highly efficient backends.
        </motion.p>
        ...
        >
          {["React.js", "Node.js", "Express.js", "MongoDB", "SQL"].map((tech) => (
            <div
              key={tech}
              className="
